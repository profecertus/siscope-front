    ...
    children: [
      {
        ...
        data: {
          'es-PE': require('!html-loader!markdown-loader!./md-docs/about/about-cn.md'),
      ...
      },
      {
        ...
        component: AdminDocComponent,
        data: {
          'es-PE': require('!html-loader!markdown-loader!./md-docs/use-materials/use-materials-cn.md'),
      ...
      },
      {
        ...
        component: AdminDocComponent,
        data: {
          'es-PE': require('!html-loader!markdown-loader!./md-docs/dev-materials/dev-materials-cn.md'),
